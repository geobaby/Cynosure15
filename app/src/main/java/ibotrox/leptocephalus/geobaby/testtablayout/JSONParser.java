...
//    }
    ...
    public JSONObject makeHttpRequest(String url, List<NameValuePair> params) {
        ...
        try {
            ...
            //above 4 lines added and the below constructor's argument added.total 5
            ...
            is = httpEntity.getContent();   //Retrieving the contents of $response
